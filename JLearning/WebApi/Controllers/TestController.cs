...
namespace WebApi.Controllers
{
    ...
    public class TestController : ControllerBase
    {
        ...
        [HttpPost("get/by-id")]
        public ActionResult Get(int test_id)
        {
            var test = repository.FindTestById(test_id);
        ...
        [HttpPost("update")]
        public ActionResult Put([FromBody][Bind("test_id,chapter_id,test_name,course_id,description,duration")] TestDTO testDTO)
        {
        ...
        [HttpPost("delete")]
        public ActionResult Delete([FromBody] int test_id)
        {
            var test = repository.FindTestById(test_id);
            if (test == null) return NotFound();
            else
